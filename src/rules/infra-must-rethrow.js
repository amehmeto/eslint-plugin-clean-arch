/**
 * @fileoverview Enforce that catch blocks in a target layer rethrow errors after logging.
 * Infra layer (by default) should log errors with context but rethrow them so callers can decide
...
export default {
  ...
  create(context) {
    ...
    // Only apply to target layer files, excluding tests

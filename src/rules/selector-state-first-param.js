...
export default {
  ...
  create(context) {
    ...
    // Only apply to files in the configured selectors directory
    if (!isInDirectory(filename, options.directory)) {
      return {}
    }
    ...
    function checkSelector(node, name, params) {
      // Note: Functions are filtered by name prefix in VariableDeclarator
      // and FunctionDeclaration visitors before reaching this function.
